                ...
                <aside className="main-sidebar">
                    ...
                    <section className="sidebar">
                        ...
                        <ul className="sidebar-menu">
                            ...
                            {this.props.location.state.menus.map(menu => {
                                return (
                                    <li key={menu.menuId} className="treeview">
                                        <a href="#"><i className="fa fa-link"></i> <span>{menu.menuNm}</span> <i className="fa fa-angle-left pull-right"></i></a>
                                        <ul className="treeview-menu">
                                            {menu.subMenus.map(subMenu =>
                                                <li key={subMenu.menuId}><Link to={subMenu.menuUrl}>{subMenu.menuNm}</Link></li>
                                            )}
                                        </ul>
                                    </li>
                                )
